all: jogo.o arbitro.o cliente.o
	...
	gcc ./Arbitro/arbitro.o ./Arbitro/initConfig.o ./Arbitro/comunicacao.o ./Arbitro/jogadores.o -o arbitro
...
arbitro.o: ./Arbitro/arbitro.c ./Arbitro/arbitro.h ./Arbitro/initConfig.c  ./Arbitro/initConfig.h ./Arbitro/comunicacao.c ./Arbitro/comunicacao.h ./Arbitro/jogadores.c
